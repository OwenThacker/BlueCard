...
# Helper function to create enhanced timeline chart with historical data
# Enhanced timeline chart function with exact dates
def create_timeline_chart(income_sources):
    ...
    for i, source in enumerate(income_sources):
        ...
        for j, key in enumerate(date_keys[:12]):  # Only look at historical keys
